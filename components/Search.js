...
class Search extends Component {
    ...
    onInputValueChange = debounce(async (query) => {
        if (query.length) {
            ...
            const [results, urbitOrgResults, devResults, opsResults] =
                await Promise.all([search, urbitOrgSearch, devSearch, opsSearch]);
